...
const THIRD := ("Circle as many numbers right of {partial_completion} as "
		+ "in the ones digit of {addend}. That is, {addend_ones} numbers.")
const FOURTH := ("This shows {start_number} + {addend}. "
		+ "Click the \"Complete\" button to say you're done.")
